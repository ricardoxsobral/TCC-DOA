...
<body>
    ...
    <div class="header">
        ...
        <div class="small-container">
            <?php
            $sqli = "SELECT * FROM tb_itens WHERE ds_tipo = 'Alimentos' AND dt_conclusao IS null;";
            $result = mysqli_query($conexao, $sqli);
        
            if (mysqli_num_rows($result)  > 0) {
            ?>
                <div class="small-container">
                    <h2 class="tittle">Alimentos</h2>
                    <div class="row">
                        <?php
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col-1">
                        ...
                        <p class="color">Você já fez uma boa ação hoje?</p>
                    </div>
                    ...
                    <div class="footer-col-3">
                        ...
                        <ul>
                            <li>Perfil</li>
                            <li>Doações</li>
                            <li ><a class="color" href="sobre.php">Quem Somos</a></li>
                        </ul>
                    </div>
