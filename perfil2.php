...
<body>
    ...
    <div class="header">
        ...
        <?php
            $id2 = $_GET['pagina2'];
            $sqli = "SELECT * from tb_usuario where cd_usuario = '$id2'";
        ...
        <div class="account-page">
            <div class="container">
                <div class="rowl">
                    <center>
                        <div class="col-2lp">
                            <img class="perfil-img" src="assets/<?php echo $datos['nm_img']; ?>">
                            <h4><?php echo $datos['nm_usuario']; ?></h4>
                        </div>
                    </center>
                    <div class="col-2l">
                        <div class="form-containerp">
                            ...
                            <h3><span class="text2p"><?php echo $datos['ds_email']; ?></span></span></h3>
                            <div class="dados">
                                <i class="fa fa-phone-square" id="iconesp" aria-hidden="true"></i>
                            </div>
                            <h3><span class="text2p"><?php echo $datos['cd_telefone']; ?></span></span></h3>
                            <div class="dados">
                                <i class="fa fa-map-marker" id="iconesp" aria-hidden="true"></i>
                            </div>
                            <h3 style="margin-bottom: 8px;"><span class="text2p"><?php echo $datos['nm_cidade']; ?> (<?php echo $datos['sg_estado']; ?>)</span></span></h3>
        ...
        <?php
        $id2 = $_GET['pagina2'];
        $sqli = "SELECT * from tb_itens where cd_usuario = '$id2'";
        $result = mysqli_query($conexao, $sqli);
