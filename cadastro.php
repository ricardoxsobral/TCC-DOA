...
if (isset($_POST['botao'])) {
    ...
    $sql = "INSERT INTO tb_usuario ( cd_telefone,  ds_email, ds_senha, nm_cidade, nm_usuario, sg_estado, dt_nascimento, cd_cep, ds_bairro, ds_rua, nm_img, cd_cpf, cd_cnpj) VALUES ('" . $telefone . "',  
    '" . $email . "', '" . $senha . "', '" . $cidade . "', '" . $nome . "', '" . $uf . "', '" . $nascimento . "', '" . $cep . "', '" . $bairro . "', '" . $rua . "', '" . $imagem . "', '" . $cpf . "', '" . $cnpj . "' )";
                ...
                <?php
                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="telefone" placeholder="Digite seu Telefone" maxlength="11" required>
                        </div>
                        <div class="input-box">
                        ...
                        <button class="botaoR" name="botao" type="submit" >Cadastrar</button>
                    </div>
                </form>
            </div>
        </center>
